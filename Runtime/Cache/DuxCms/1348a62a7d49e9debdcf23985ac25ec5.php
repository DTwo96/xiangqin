<?php if (!defined('THINK_PATH')) exit();?><h3>扩展模型列表</h3>

        <div class="m-panel ">
            <div class="panel-body">
            <div class="m-table-mobile"><table id="table" class="m-table m-table-border"><thead><tr><th width="50">编号</th><th>名称</th><th>表名</th><th>状态</th><th width="160">操作</th></tr></thead><tbody><?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
        ...
        <td>
        <a class="u-btn u-btn-primary u-btn-small" href="<?php echo U('AdminExpandField/index',array('fieldset_id'=>$vo['fieldset_id']));?>">管理</a>
